...
def load_manual_deps():
    go_repository(
        name = "com_github_fusionauth_go_client",
        importpath = "github.com/FusionAuth/go-client",
        tag = "1.17.5",
    )
...
def load_golang_deps():
    ...
    go_repository(
        ...
        sum = "h1:hYz4ZVdUgjXTBUmrkrw55j1nHx68LfOKIQk5IYtyScg=",
        version = "v1.19.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qT6qOR9/mp9hrHAgTEVxpjvS3anQtiUTtzJhf+NlBQM=",
        version = "v0.0.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:8HkTBT/jXzfqSggaZIhi3LmWRB0wFT3WyOj24yWoXDA=",
        version = "v1.0.3",
    )
    go_repository(
